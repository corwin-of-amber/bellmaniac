...
void func(DEFINTERVALFUNC(I0),DEFINTERVALFUNC(J0),DEFINTERVALFUNC(J1),DEFINTERVALFUNC(K2)){
...
void func0(DEFINTERVALFUNC(I0),DEFINTERVALFUNC(J0),DEFINTERVALFUNC(J1),DEFINTERVALFUNC(K3)){
...
void funcC_rec(DEFINTERVALFUNC(I0),DEFINTERVALFUNC(I1),DEFINTERVALFUNC(J)){
	if(BASE_CONSTRAINT(PARAM(I0),PARAM(I1),PARAM(J))){
		...
		DEFINTERVALSTMT_LOWER(J0, J);
		DEFINTERVALSTMT_UPPER(J1, J);
		cilk_spawn funcC_rec(PARAM(J0),PARAM(K0),PARAM(K2));;
		cilk_spawn func(PARAM(I0),PARAM(J0),PARAM(J1),PARAM(K2));;
		cilk_spawn funcC_rec(PARAM(J0),PARAM(K0),PARAM(K3));;
		func0(PARAM(I0),PARAM(J0),PARAM(J1),PARAM(K3));
		cilk_sync;

		cilk_spawn funcC_rec(PARAM(J0),PARAM(K1),PARAM(K2));;
		cilk_spawn funcC_rec(PARAM(J1),PARAM(K0),PARAM(K2));;
		cilk_spawn funcC_rec(PARAM(J0),PARAM(K1),PARAM(K3));;
		funcC_rec(PARAM(J1),PARAM(K0),PARAM(K3));
		cilk_sync;

		cilk_spawn funcC_rec(PARAM(J1),PARAM(K1),PARAM(K2));;
		funcC_rec(PARAM(J1),PARAM(K1),PARAM(K3));
		cilk_sync;
