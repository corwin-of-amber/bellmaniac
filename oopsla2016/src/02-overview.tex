...
The trusted core is small, comprising of: (a) a type checker (see \Cref{lang:types}), 
(b) a term substitution procedure (see \Cref{tactics}),
(c) a formula simplifier (see \Cref{automated:simplification}),
