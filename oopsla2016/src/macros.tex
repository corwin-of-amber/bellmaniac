...
% Bellmania code listings
\lstdefinelanguage{bellmania}{
  literate=*%
    {->}{$\rightarrow$}2
    {|->}{$\mapsto$}1
    {(small)|->}{$\scriptstyle\mapsto$}1
    {\\theta}{$\theta$}1
    {\\psi}{$\psi$}1
    {<|}{$\langle$}1
    {|>}{$\rangle$}1
    {*}{{\raisebox{1pt}{\scalebox{0.75}{$\times\,$}}}}1
    {_0}{{\textsubscript{0}}}1
    {_1}{{\textsubscript{1}}}1
    {_2}{{\textsubscript{2}}}1
    {_3}{{\textsubscript{3}}}1
...
\newcommand{\nilvar}{{\textit{nil}}}
%\newcommand{\undefined}{{\textit{ndef}}}  % conflicts with TeX builtins!
