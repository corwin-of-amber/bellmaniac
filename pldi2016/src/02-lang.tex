...
\begin{itemize}
  ...
  \item A conditional operator $\,\big|_{\scriptscriptstyle\square}\,$, which comes in two flavors:
  \[\begin{array}{l}
      x|_{\mathit{cond}} = \begin{cases}x & \mathit{cond} \\ \bot & \lnot\mathit{cond}\end{cases} \\
      f|_{P_1\times P_2\times \cdots P_n} = \overline{x} \mapsto f(\overline{x})\big|_{\bigwedge P_i(x_i)}
    \end{array}\]
  ...
  parts of the array. For example, \[\psi\mapsto (f\,\psi)\big|_{I_0} ~ \Big/ ~ (g\,\psi)\big|_{I_1}\]
