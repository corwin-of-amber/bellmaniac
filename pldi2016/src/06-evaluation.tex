...
divide-and-conquer implementations of several textbook and naturally occurring
algorithms.
...
\begin{paragraph}{Longest Common Subsequence}
Given two sequences $X,Y \in \Sigma^*$,
the LCS of $X$ and $Y$ is a string $W\in \Sigma^*$ such that $X=\alpha W\beta$ and $Y=\gamma W\delta$
for appropriate $\alpha,\beta,\gamma,\delta$, and which maximizes $|W|$.
\end{paragraph}
