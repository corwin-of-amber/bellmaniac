...
var grammar = {
  ...
  function(d, loc, reject) { return declareSets(d[0], d[1].map(take(1))) || reject; } },
    ...
    {"name": "op", "symbols": ["opchar", " ebnf$8"], "postprocess":  function(d) { return [d[0]].concat(d[1]).join(""); } },
    ...
    {"name": "escaped", "symbols": [/["]/, " ebnf$9", /["]/], "postprocess":  function(d) { return d[1].join(""); } },
    {"name": "_", "symbols": [" ebnf$10"], "postprocess":  function(d) {return null; } },
    {"name": "__", "symbols": [" ebnf$11"], "postprocess":  function(d) {return null; } },
    ...
    {"name": "typeArrow", "symbols": [" string$12"], "postprocess":  id },
    {"name": " string$13", "symbols": [{"literal":"f"}, {"literal":"i"}, {"literal":"x"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "fix", "symbols": [" string$13"]},
    {"name": " ebnf$1", "symbols": [" subexpression$14"], "postprocess": id},
    {"name": " ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": " ebnf$2", "symbols": []},
    {"name": " ebnf$2", "symbols": [" subexpression$15", " ebnf$2"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$4", "symbols": []},
    {"name": " ebnf$4", "symbols": [" subexpression$16", " ebnf$4"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$5", "symbols": [" subexpression$17"]},
    {"name": " ebnf$5", "symbols": [" subexpression$18", " ebnf$5"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$6", "symbols": []},
    ...
    {"name": " ebnf$8", "symbols": ["opchar"]},
    {"name": " ebnf$8", "symbols": ["opchar", " ebnf$8"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$9", "symbols": []},
    {"name": " ebnf$9", "symbols": [/[^"]/, " ebnf$9"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$10", "symbols": []},
    {"name": " ebnf$10", "symbols": [/[\s]/, " ebnf$10"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$11", "symbols": [/[\s]/]},
    {"name": " ebnf$11", "symbols": [/[\s]/, " ebnf$11"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " subexpression$14", "symbols": ["_", "colon", "_", "type"]},
    {"name": " subexpression$15", "symbols": ["__", "identifier"]},
    {"name": " subexpression$16", "symbols": ["_", "comma", "_", "expression"]},
    {"name": " subexpression$17", "symbols": ["possiblyTypedLambdaParameter", "__"]},
