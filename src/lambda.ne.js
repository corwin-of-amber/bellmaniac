...
var grammar = {
    ...
    {"name": "setDeclaration", "symbols": ["identifier", " ebnf$2", "_", "colon", "_", " string$3"], "postprocess": 
  function(d, loc, reject) { return declareSets(d[0], d[1].map(take(1))) || reject; } },
    ...
    {"name": "num", "symbols": [" ebnf$8"], "postprocess":  function(d) { return parseInt(d[0].join("")); } },
    {"name": "op", "symbols": ["validStandaloneOpchars"], "postprocess":  id },
    {"name": "op", "symbols": ["opchar", " ebnf$9"], "postprocess":  function(d) { return [d[0]].concat(d[1]).join(""); } },
    ...
    {"name": "escaped", "symbols": [/["]/, " ebnf$10", /["]/], "postprocess":  function(d) { return d[1].join(""); } },
    {"name": "_", "symbols": [" ebnf$11"], "postprocess":  function(d) {return null; } },
    {"name": "__", "symbols": [" ebnf$12"], "postprocess":  function(d) {return null; } },
    ...
    {"name": "typeArrow", "symbols": [" string$13"], "postprocess":  id },
    {"name": " string$14", "symbols": [{"literal":"f"}, {"literal":"i"}, {"literal":"x"}], "postprocess": function joiner(d) {
        return d.join('');
    }},
    {"name": "fix", "symbols": [" string$14"]},
    {"name": " ebnf$1", "symbols": [" subexpression$15"], "postprocess": id},
    {"name": " ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": " ebnf$2", "symbols": []},
    {"name": " ebnf$2", "symbols": [" subexpression$16", " ebnf$2"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$4", "symbols": []},
    {"name": " ebnf$4", "symbols": [" subexpression$17", " ebnf$4"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$5", "symbols": [" subexpression$18"]},
    {"name": " ebnf$5", "symbols": [" subexpression$19", " ebnf$5"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$6", "symbols": []},
    ...
    {"name": " ebnf$8", "symbols": ["digit"]},
    {"name": " ebnf$8", "symbols": ["digit", " ebnf$8"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$9", "symbols": ["opchar"]},
    {"name": " ebnf$9", "symbols": ["opchar", " ebnf$9"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$10", "symbols": []},
    {"name": " ebnf$10", "symbols": [/[^"]/, " ebnf$10"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$11", "symbols": []},
    {"name": " ebnf$11", "symbols": [/[\s]/, " ebnf$11"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " ebnf$12", "symbols": [/[\s]/]},
    {"name": " ebnf$12", "symbols": [/[\s]/, " ebnf$12"], "postprocess": function (d) {
                    return [d[0]].concat(d[1]);
                }},
    {"name": " subexpression$15", "symbols": ["_", "colon", "_", "type"]},
    {"name": " subexpression$16", "symbols": ["__", "identifier"]},
    {"name": " subexpression$17", "symbols": ["_", "comma", "_", "expression"]},
    {"name": " subexpression$18", "symbols": ["possiblyTypedLambdaParameter", "__"]},
