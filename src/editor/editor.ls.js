...
(function(){
  var root, hintWords, autoWords, i$, ref$, len$, i, charCode, letter, findCurWord, findSuffixWord, hintReplace, autoReplace, cmOptions, initEditor, out$ = typeof exports != 'undefined' && exports || this;
  ...
  out$.cmOptions = cmOptions;
  out$.initEditor = initEditor;
}).call(this);
