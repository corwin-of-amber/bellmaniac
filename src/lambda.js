...
var grammar = {
    ...
    {"name": "applicationWithoutInfixExpression", "symbols": ["applicationOnNonLambdaExpression", "__", "rootExpression"], "postprocess":  function(d) {return {$: "Application", lhs: d[0], rhs: d[2]}; } },
    {"name": "applicationWithoutInfixExpression", "symbols": ["parenthesizedExpression", "__", "lambdaExpression"], "postprocess":  function(d) {return {$: "Application", lhs: d[0], rhs: d[2]}; } },
    ...
    {"name": "rootExpression", "symbols": ["parenthesizedExpression"], "postprocess":  function(d) {return d[0]; } },
    ...
    {"name": "lambdaExpression", "symbols": [" ebnf$2", "arrow", "_", "expression"], "postprocess": 
	function(d) {
    ...
    {"name": "possiblyTypedVariable", "symbols": ["variable"], "postprocess":  function(d) {return d[0];} },
    {"name": "possiblyTypedVariable", "symbols": ["leftparen", "variable", "_", "colon", "_", "type", "rightparen"], "postprocess":  function(d) { d[1].type = d[5]; return d[1]; } },
    ...
    {"name": " subexpression$10", "symbols": ["possiblyTypedVariable", "_"]},
