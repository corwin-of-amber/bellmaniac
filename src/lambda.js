...
var grammar = {
    ...
    {"name": "applicationWithInfixExpression", "symbols": ["applicationOnNonLambdaExpression", "__", "infixOperator", "__", "applicationExpression"], "postprocess":  function(d) {return {$: "Tree", lhs: {$: "Tree", lhs: d[2], rhs: d[0]}, rhs: d[4]}; } },
    ...
    {"name": "op", "symbols": ["opchar", " ebnf$5"], "postprocess":  function(d) { return [d[0]].concat(d[1]).join(""); } },
    ...
    {"name": "typeArrow", "symbols": [" string$8"], "postprocess":  id },
