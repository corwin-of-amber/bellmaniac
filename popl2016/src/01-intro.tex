...
Divide-and-conquer is a common algorithm development pattern~\cite{09/CLRS} that has recently
...
He \emph{stratified} the computations on these quadrants into the following
four steps:
\begin{algorithmic}[1]
