...
\begin{abstract}
Programmers almost never write optimal code right from the start.
Instead, they usually begin with a simplified, possibly inefficient implementation, or even
a na\"ive one. When the output is satisfactory, they would move
on to revise the code in order to improve performance. These revisions normally
...
must be taken into account for parallel code in order to fully utilize all available
resources.
